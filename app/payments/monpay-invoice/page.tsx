...
export default function MonpayInvoicePage() {
  ...
  useEffect(() => {
    ...
    const generateQrCode = () => {
      ...
      // Жишээ QR код дата (бодит тохиолдолд MonPay API-аас авна)
      const invoiceId = `INV${Date.now()}`
      const deepLink = `https://monpay.mn/payment/${invoiceId}`
  ...
  const copyDeepLink = () => {
    ...
    toast({
      ...
      description: "MonPay төлбөрийн холбоос хуулагдлаа",
    })
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500">MonPay төлбөрийн мэдээлэл ачаалж байна...</p>
        </div>
      </div>
    )
  }
        ...
        <Card className="shadow-md">
          <CardHeader className="text-center border-b pb-6">
            <div className="mx-auto mb-4 w-16 h-16 relative">
              <Image src="/payment-logos/monpay.png" alt="MonPay" fill className="object-contain" />
            </div>
            <CardTitle>MonPay төлбөр</CardTitle>
              ...
              <>
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-3 bg-purple-50 rounded-lg">
                    <div>
                      <div className="text-sm font-medium text-purple-800">Хүчинтэй хугацаа</div>
          ...
          <CardFooter className="flex flex-col border-t pt-6">
            <div className="text-center text-sm text-gray-500 mb-4">Та MonPay апп-д нэвтэрч төлбөрөө хийнэ үү</div>
            <div className="flex justify-center">
              <Button
                variant="outline"
                className="text-purple-600 border-purple-200"
                onClick={() => window.open("https://monpay.mn/download", "_blank")}
              >
                MonPay апп татах
              </Button>
            </div>
