...
export default function QpayInvoicePage() {
  ...
  useEffect(() => {
    ...
    const generateQrCode = () => {
      ...
      // Жишээ QR код дата (бодит тохиолдолд QPay API-аас авна)
      const invoiceId = `INV${Date.now()}`
      const deepLink = `https://qpay.mn/payment/${invoiceId}`
  ...
  const copyDeepLink = () => {
    ...
    toast({
      ...
      description: "QPay төлбөрийн холбоос хуулагдлаа",
    })
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500">QPay төлбөрийн мэдээлэл ачаалж байна...</p>
        </div>
      </div>
    )
  }
        ...
        <Card className="shadow-md">
          <CardHeader className="text-center border-b pb-6">
            <div className="mx-auto mb-4 w-16 h-16 relative">
              <Image src="/payment-logos/qpay.png" alt="QPay" fill className="object-contain" />
            </div>
              ...
              <>
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
                    <div>
                      <div className="text-sm font-medium text-blue-800">Хүчинтэй хугацаа</div>
          ...
          <CardFooter className="flex flex-col border-t pt-6">
            <div className="text-center text-sm text-gray-500 mb-4">Та QPay апп-д нэвтэрч төлбөрөө хийнэ үү</div>
            <div className="flex flex-wrap justify-center gap-2">
              {["Khan Bank", "TDB", "Golomt", "State Bank", "Xac Bank"].map((bank) => (
                <div
                  key={bank}
                  className="px-3 py-1 bg-white rounded border border-gray-200 text-xs font-medium text-gray-700"
                >
                  {bank}
                </div>
              ))}
